...
export function RunActivityPanel(props: { activity: ReturnTypeUseRunActivity }) {
  ...
  return <div testId="run-activity-panel" style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0, gap: 10, padding: 12, overflow: "scroll" }}>
    ...
    <div style={sectionStyle()}><text style={headingStyle()}>Approvals</text><Approvals approvals={state.approvals} onDecide={state.decide} /></div>
