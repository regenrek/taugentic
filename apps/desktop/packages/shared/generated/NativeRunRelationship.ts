 ...
 */
export type NativeRunRelationship = { "kind": "root" } | { "kind": "nativeSubagent", parentRunId: RunId, } | { "kind": "freshSpawn", parentRunId: RunId, } | { "kind": "fork", parentRunId: RunId, parentEventSeq: string, } | { "kind": "accountSwitchedContinuation", parentRunId: RunId, parentEventSeq: string, };
