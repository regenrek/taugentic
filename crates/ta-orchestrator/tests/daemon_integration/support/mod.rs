...
pub use ta_protocol::wire::{
    ...
    ApprovalDecision, ApprovalId, ApprovalSnapshotResult, ArtifactSnapshotResult, ArtifactSummary,
    AuthProfileId, DAEMON_PROTOCOL_VERSION, DAEMON_SOCKET_NAME_ENV_VAR, DaemonApprovalDecideParams,
    ...
    METHOD_DAEMON_ACTIVITY_PAGE, METHOD_DAEMON_APPROVAL_DECIDE, METHOD_DAEMON_APPROVAL_LIST,
    METHOD_DAEMON_ARTIFACT_GET, METHOD_DAEMON_ARTIFACT_LIST, METHOD_DAEMON_CONTROL_STATUS,
    METHOD_DAEMON_INITIALIZE, METHOD_DAEMON_RUN_GET, METHOD_DAEMON_RUN_LIST,
    METHOD_DAEMON_RUN_REPLAY_EVENTS, METHOD_DAEMON_RUN_START, METHOD_DAEMON_SESSION_ATTACH,
    METHOD_DAEMON_SESSION_GET, METHOD_DAEMON_SESSION_LIST, METHOD_DAEMON_SESSION_OPEN,
    METHOD_DAEMON_STATUS, METHOD_DAEMON_SUBSCRIBE, PublicActivityPageResult, PublicApprovalEvent,
    PublicDaemonEvent, PublicDaemonEventEnvelope, RunDetail, RunId, RunStatus, RunSummary,
    RuntimeProfileId, SessionAuthority, SessionId, SessionSummary, StartRunCommand,
    SubscribeRunEventsRequest, SubscribeRunEventsResult, WorkspaceSelector,
};
pub use ta_store::{
