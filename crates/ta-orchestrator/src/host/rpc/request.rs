use crate::{
    ...
    DaemonSessionOpenParams, DaemonStatusParams, DaemonSubscribeParams, DaemonWorkspaceGetParams,
    DaemonWorkspaceListParams, DaemonWorkspaceOpenParams, ForkRunRequest, GetAgentRuntimeQuery,
    GetArtifactQuery, GetRunQuery, GetRunTimelineQuery, GetSessionQuery, JsonRpcErrorObject,
    JsonRpcRequest, ListApprovalsQuery, ListArtifactsQuery, ListNativeRunsRequest,
    ListReceiptsRequest, ListRunsQuery, ListSessionsQuery, METHOD_DAEMON_ACTIVITY_PAGE,
    ...
    METHOD_DAEMON_RUN_FORK, METHOD_DAEMON_RUN_GET, METHOD_DAEMON_RUN_LIST,
    METHOD_DAEMON_RUN_LIST_NATIVE, METHOD_DAEMON_RUN_REPLAY_EVENTS, METHOD_DAEMON_RUN_RESUME,
    METHOD_DAEMON_RUN_START, METHOD_DAEMON_RUN_SUBSCRIBE_EVENTS, METHOD_DAEMON_RUN_TIMELINE,
    METHOD_DAEMON_SESSION_ATTACH, METHOD_DAEMON_SESSION_GET, METHOD_DAEMON_SESSION_LIST,
    METHOD_DAEMON_SESSION_OPEN, METHOD_DAEMON_SESSION_OVERVIEW, METHOD_DAEMON_STATUS,
    METHOD_DAEMON_SUBSCRIBE, METHOD_DAEMON_WORK_ITEM_DISMISS, METHOD_DAEMON_WORK_ITEM_LIST,
    ...
    METHOD_WORKFLOW_RELOAD, METHOD_WORKFLOW_STATUS, METHOD_WORKFLOW_VALIDATE,
    PromoteReceiptRequest, QuarantineReceiptRequest, ResumeRunRequest, SessionOverviewQuery,
    StartRunCommand, SubscribeRunEventsRequest, WorkItemDismissParams, WorkItemListQuery,
    WorkItemRefreshParams, WorkItemTriggerParams, WorkflowLoadParams, WorkflowReloadParams,
...
pub(super) enum DaemonRpcRequest {
    ...
    AgentRuntimeProfileSelect(DaemonAgentRuntimeSelectProfileParams),
    ...
    pub(super) fn parse(request: &JsonRpcRequest) -> Result<Self, JsonRpcErrorObject> {
        match request.method.as_str() {
            ...
            METHOD_DAEMON_AGENT_RUNTIME_PROFILE_SELECT => {
                Ok(Self::AgentRuntimeProfileSelect(parse_params(request)?))
            }
