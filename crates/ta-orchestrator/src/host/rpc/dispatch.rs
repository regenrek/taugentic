...
use crate::{
    ...
    METHOD_DAEMON_SESSION_OPEN, METHOD_DAEMON_SESSION_OVERVIEW, METHOD_DAEMON_WORK_ITEM_DISMISS,
    ...
    OpenSessionRequest, RecipeListResponse,
    host::{
...
pub(super) async fn handle_request(
    ...
    match request {
        ...
        DaemonRpcRequest::AgentRuntimeLocalEndpointTest(params) => {
            ensure_initialized(
                session_state,
            ...
            let result = state
                .app
                .test_local_model_endpoint(&params)
                .await
                .map_err(map_app_service_error)?;
            json_result(result)
        }
